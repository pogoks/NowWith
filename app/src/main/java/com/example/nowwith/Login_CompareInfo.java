...
public class Login_CompareInfo extends StringRequest {
    // 웹서버에 있는 PHP문에 접근하기 위한 주소를 URL변수에 저장
    final static private String URL = "http://35.203.164.40/NW_Login.php";
    // String 두개로 구성되어 값들을 받아올 Map 생성
    private Map<String, String> parameters;

    // 생성자, 요청이 들어오면 ID와 PW를 받아서 POST 방식으로 해당 주소로 전송한다.
    public Login_CompareInfo(String userID, String userPW, Response.Listener<String> listener) {
